...
// consomme VocabulaireCloud. La scène de recherche de la maquette, elle, ne filtre
// plus : elle IMPOSE une catégorie (cf. la prop `category` du nuage) et n'utilise
// donc que `words` + les libellés.
